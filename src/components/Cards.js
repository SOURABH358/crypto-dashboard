...
function Cards() {
    return <section id="cards__container" className="relative overflow-hidden w-full h-48 p-4">
            <div className="absolute top-0 left-0 flex items-center w-4 h-48 text-white z-10">
                <FaAngleLeft className="text-2xl"/>
            </div>
            <div className="absolute right-0 top-0 flex items-center w-4 h-48 z-10 text-white cursor-pointer">
                <FaAngleRight className="text-2xl"/>
            </div>
        <div className="w-fit flex gap-x-4 h-full translate-x-[25%] ">
